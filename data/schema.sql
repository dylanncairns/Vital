...
CREATE INDEX idx_claims_symptom ON claims(symptom_id);
CREATE INDEX idx_exposure_events_user ON exposure_events(user_id);
CREATE INDEX idx_symptom_events_user ON symptom_events(user_id);
...
CREATE INDEX idx_rag_source_documents_user_created ON rag_source_documents(user_id, created_at);
CREATE INDEX idx_rag_source_documents_hash ON rag_source_documents(source_hash);
INSERT INTO model_retrain_state (id, last_trained_total_events, last_enqueued_total_events, updated_at)
VALUES (1, 0, 0, NOW())
