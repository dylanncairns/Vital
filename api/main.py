...
# Validate input JSON payload format for /events
# Metadata will contain user_id and either item_id + route or symptom_id + severity
...
# Output JSON payload format for /events (adds event id from sqlite exposure_events table) - echo ID
